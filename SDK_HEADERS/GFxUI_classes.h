...
public:
	...
	TArray< struct FName >                             ForceGarbageCollectUponReleaseTextures;           		// 0x0074 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
public:
	...
	unsigned long                                      m_bIsMuted : 1;                                   		// 0x0114 (0x0004) [0x0000000000000000] [0x04000000] 
	...
	struct FGFxStoredViewportParams                    m_StoredViewportParams;                           		// 0x01D4 (0x0014) [0x0000000000000000]              
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                        		// 0x01E8 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	int                                                Value[ 0xC ];                                     		// 0x0068 (0x0030) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	TArray< struct FGFxWidgetBinding >                 SubWidgetBindings;                                		// 0x0098 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      m_bHasCallbacksBound : 1;                         		// 0x00A8 (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	unsigned long                                      bUseStreamableTextures : 1;                       		// 0x00A0 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 37770 );
