...
public:
	...
	void ProcessEvent(class UFunction* pFunction, void* pParams, void* pResult) {
		typedef void(__fastcall* tProcessEvent) (UObject*, UFunction*, void*, void*);

		static tProcessEvent pOrgProcessEvent = nullptr;
		if (!pOrgProcessEvent) {
			pOrgProcessEvent = (tProcessEvent)((DWORD64)GetModuleHandleA(NULL) + (DWORD64)0x95A10);
		}

		pOrgProcessEvent(this, pFunction, pParams, (void*)1);
...
public:
	...
	TArray< struct FString >                           ArchivePaths;                                     		// 0x013C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
public:
	...
	int32_t	        PropertySize;                                		// NOT AUTO-GENERATED PROPERTY 
...
{
public:
	int32_t FunctionFlags;                                    		// NOT AUTO-GENERATED PROPERTY 
	int16_t iNative;                                          		// NOT AUTO-GENERATED PROPERTY 
	int16_t RepOffset;                                        		// NOT AUTO-GENERATED PROPERTY 
	struct FName FriendlyName;                                   		// NOT AUTO-GENERATED PROPERTY 
	int16_t NumParms;                                     		// NOT AUTO-GENERATED PROPERTY 
	int16_t ParmsSize;                                         		// NOT AUTO-GENERATED PROPERTY 
	int16_t ReturnValueOffset;                                       		// NOT AUTO-GENERATED PROPERTY 
	char UnknownData00[0xA];                               		// NOT AUTO-GENERATED PROPERTY 
...
{
public:
	unsigned char                                      UnknownData00[ 0xE0 ];                            		// 0x0124 (0x00E0) MISSED OFFSET
