...
{
	TArray< struct FString >                           List;                                             		// 0x0000 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	struct FString                                     sTimerCommand;                                    		// 0x0000 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	struct FString                                     Reason;                                           		// 0x0000 (0x0010) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	struct FPostProcessSettings                        PP;                                               		// 0x0000 (0x0180) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
struct UGameCameraBase_execUpdateCamera_Parms
{
	...
	struct FTViewTarget                                OutVT;                                            		// 0x0014 (0x0040) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
};
...
{
	struct FTViewTarget                                OutVT;                                            		// 0x0000 (0x0040) [0x0000000000000182]              ( CPF_Const | CPF_Parm | CPF_OutParm )
...
{
	struct FTViewTarget                                OutVT;                                            		// 0x0000 (0x0040) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	float                                              DeltaTime;                                        		// 0x0040 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	// class APawn*                                    P;                                                		// 0x0044 (0x0008) [0x0000000000000000]              
	// class UGameCameraBase*                          NewCamera;                                        		// 0x004C (0x0008) [0x0000000000000000]              
	// class ACameraActor*                             CamActor;                                         		// 0x0054 (0x0008) [0x0000000000000000]              
};
...
{
	struct FTViewTarget                                VT;                                               		// 0x0000 (0x0040) [0x0000000000000182]              ( CPF_Const | CPF_Parm | CPF_OutParm )
	float                                              DeltaTime;                                        		// 0x0040 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	// struct FVector                                  FocusLoc;                                         		// 0x0044 (0x000C) [0x0000000000000000]              
	// struct FVector                                  StartTrace;                                       		// 0x0050 (0x000C) [0x0000000000000000]              
	// struct FVector                                  EndTrace;                                         		// 0x005C (0x000C) [0x0000000000000000]              
	// struct FVector                                  CamDir;                                           		// 0x0068 (0x000C) [0x0000000000000000]              
	// float                                           FocusDist;                                        		// 0x0074 (0x0004) [0x0000000000000000]              
	// float                                           SubjectDist;                                      		// 0x0078 (0x0004) [0x0000000000000000]              
	// float                                           Pct;                                              		// 0x007C (0x0004) [0x0000000000000000]              
};
...
struct UGameThirdPersonCameraMode_eventGetCameraWorstCaseLoc_Parms
{
	...
	struct FTViewTarget                                CurrentViewTarget;                                		// 0x0008 (0x0040) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     ReturnValue;                                      		// 0x0048 (0x000C) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct APlayerCollectorGame_eventLogin_Parms
{
	...
	struct FUniqueNetId                                ConsoleUniqueId;                                  		// 0x0038 (0x0008) [0x0000000000000092]              ( CPF_Const | CPF_OptionalParm | CPF_Parm )
